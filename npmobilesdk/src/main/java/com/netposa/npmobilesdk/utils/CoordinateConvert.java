...
public class CoordinateConvert {
     ...
     * 经纬度-> 墨卡托
     */
    public static Point webMoctorJW2PM(double xdouble, double ydouble) {
     ...
     * 墨卡托 -> 经纬度
     */
    public static Point inverseMercator(double xdouble, double ydouble) {
        Point lonLat = new Point();
     ...
     * 经纬度->火星
     */
    public static Point transform(double xdouble, double ydouble) {
        Point lonLat = new Point();
     ...
     * 火星->百度
     */
    public static Point encryptToBd(double xdouble, double ydouble) {
        Point lonLat = new Point();
     ...
     * 火星->经纬度
     */
    public static Point gcj2wgs(double xdouble, double ydouble) {
        Point lonLat = new Point();
     ...
     * 百度->火星
     */
    public static Point bdToDecrypt(double xdouble, double ydouble) {
        Point lonLat = new Point();
